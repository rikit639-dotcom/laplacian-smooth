...
public class LaplacianSmoothPlugin extends Plugin {
    ...
    public LaplacianSmoothPlugin(PluginInformation info) {
        ...
        org.openstreetmap.josm.gui.MainMenu menuBar = MainApplication.getMenu();
        javax.swing.JMenu myToolsMenu = null;
        String menuTitle = org.openstreetmap.josm.tools.I18n.tr("Mytools");
        
        if (menuBar != null) {
            for (int i = 0; i < menuBar.getMenuCount(); i++) {
                javax.swing.JMenu m = menuBar.getMenu(i);
            ...
            if (myToolsMenu == null) {
                myToolsMenu = new javax.swing.JMenu(menuTitle);
